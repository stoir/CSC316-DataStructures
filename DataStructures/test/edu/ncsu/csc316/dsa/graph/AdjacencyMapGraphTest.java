...
public class AdjacencyMapGraphTest {
	...
	public void testOutgoingEdges() {
		...
		undirectedGraph.incomingEdges(v1);
	...
	/**
	 * Helper method to check that an array contains a certain target. This is
	 * helpful for testing graph ADT behaviors where an order of edges cannot be
	 * guaranteed (such as .outgoingEdges or .incomingEdges)
	 * 
	 * @param temp   to check in
	 * @param target to check for
	 * @return if target is in temp or not
	 */
	...
	public void testIncomingEdges() {
		...
		assertEquals(0, undirectedGraph.inDegree(v1));
	}
